          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group bg-white p-8 rounded-2xl shadow-soft border border-gray-100 hover:shadow-medium transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Controle todo o processo de confecção desde o corte até a
                finalização
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-soft border border-gray-100 hover:shadow-medium transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Organize e acompanhe o trabalho de costureiras e operadores
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-soft border border-gray-100 hover:shadow-medium transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Gerencie tecidos, aviamentos e produtos em processo
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-soft border border-gray-100 hover:shadow-medium transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Acompanhe produtividade e eficiência da confecção
              </p>
            </div>
          </div>
        </div>
              ...
              <ul className="space-y-6">
                <li className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Otimize processos e aumente a eficiência da produção
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Garanta padrões de qualidade em todas as etapas
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Cumpra entregas e mantenha clientes satisfeitos
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Minimize desperdícios e otimize o uso de materiais
                    </p>
                  </div>
                </li>
              </ul>
            ...
            <div className="space-y-6 text-gray-700">
              <div>
                <h3 className="text-xl font-semibold text-gray-900">
                  Qual o principal erro no controle de faccao?
                </h3>
                <p className="mt-2">
                  Falta de rastreabilidade por etapa, que gera atrasos,
                  retrabalho e perda de previsibilidade de entrega.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-gray-900">
                ...
                <p className="mt-2">
                  Lead time por etapa, taxa de retrabalho, pecas em atraso e
                  produtividade por faccao.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-gray-900">
                  Planilha ainda resolve para confeccao?
                </h3>
                <p className="mt-2">
                  No inicio pode ajudar, mas perde eficiencia quando aumenta
                  volume, equipe e parceiros externos.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-gray-900">
                ...
                <p className="mt-2">
                  Com fluxo minimo definido, em 2 a 4 semanas ja e comum reduzir
                  gargalos visiveis.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link href={getCalendlyUrl()}>
                <Button
                  size="lg"
                  className="bg-white hover:bg-gray-100 text-pink-700 px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
                >
