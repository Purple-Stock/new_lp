          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group bg-white p-8 rounded-2xl shadow-soft border border-gray-100 hover:shadow-medium transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Crie e gerencie pedidos de compra e venda com facilidade e
                precisão
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-soft border border-gray-100 hover:shadow-medium transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Acompanhe o desempenho de vendas e identifique oportunidades de
                crescimento
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-soft border border-gray-100 hover:shadow-medium transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Gere faturas automaticamente e mantenha o controle financeiro
                organizado
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-soft border border-gray-100 hover:shadow-medium transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Mantenha um histórico completo de clientes e fornecedores
              </p>
            </div>
          </div>
        </div>
              ...
              <ul className="space-y-6">
                <li className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Automatize processos manuais e reduza erros operacionais
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Tenha controle total sobre receitas, despesas e
                      lucratividade
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Acesse insights valiosos para tomada de decisões
                      estratégicas
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Sincronize dados entre vendas, estoque e financeiro
                      automaticamente
                    </p>
                  </div>
                </li>
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link href={getCalendlyUrl()}>
                <Button
                  size="lg"
                  className="bg-white hover:bg-gray-100 text-blue-700 px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
                >
