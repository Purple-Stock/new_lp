          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group bg-white p-8 rounded-2xl shadow-soft border border-gray-100 hover:shadow-medium transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Crie QR codes personalizados para cada item do seu inventário
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-soft border border-gray-100 hover:shadow-medium transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Escaneie QR codes com qualquer smartphone para acessar
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-soft border border-gray-100 hover:shadow-medium transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Gerencie seu inventário de qualquer lugar usando apenas seu
                smartphone
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-soft border border-gray-100 hover:shadow-medium transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                QR codes criptografados com controle de acesso e rastreamento de
                uso
              </p>
            </div>
          </div>
              ...
              <ul className="space-y-6">
                <li className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Acesso instantâneo às informações do inventário com um
                      simples escaneamento
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Elimine erros de digitação e garanta dados sempre corretos
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Gerencie seu inventário de qualquer lugar, sem necessidade
                      de computador
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Solução acessível que não requer equipamentos caros
                    </p>
                  </div>
                </li>
              </ul>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-8">
            ...
            <p className="text-xl lg:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              Transforme a forma como você gerencia seu inventário com a
              tecnologia QR Code mais avançada do mercado
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link href={getCalendlyUrl()}>
                <Button
                  size="lg"
                  className="bg-white hover:bg-gray-100 text-green-700 px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
                >
