          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group bg-white p-8 rounded-2xl shadow-soft border border-gray-100 hover:shadow-medium transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Organize seu almoxarifado com sistema de endereçamento
                inteligente
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-soft border border-gray-100 hover:shadow-medium transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Rastreie todas as entradas, saídas e transferências de materiais
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-soft border border-gray-100 hover:shadow-medium transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Controle quantidades, lotes e datas de validade de todos os
                itens
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-soft border border-gray-100 hover:shadow-medium transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Saiba exatamente onde está cada item e seu histórico completo
              </p>
            </div>
          </div>
        </div>
              ...
              <ul className="space-y-6">
                <li className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Elimine a desorganização e encontre qualquer item em
                      segundos
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Monitore todas as movimentações e mantenha o inventário
                      sempre atualizado
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Reduza tempo de busca e aumente a produtividade da equipe
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Identifique e previna perdas, vencimentos e obsolescência
                    </p>
                  </div>
                </li>
              </ul>
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link href={getCalendlyUrl()}>
                <Button
                  size="lg"
                  className="bg-white hover:bg-gray-100 text-orange-700 px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
                >
