  ...
  const benefits = [
    {
      ...
      description:
        "Controle preciso de equipamentos elétricos, transformadores, painéis e componentes técnicos",
    },
    {
      icon: Wrench,
      title: "Controle de Ferramentas",
      description:
        "Gestão eficiente de ferramentas, instrumentos de medição e equipamentos de teste",
    },
    {
      icon: Settings,
      title: "Manutenção Preventiva",
      description:
        "Alertas automáticos para manutenção preventiva e controle de garantias",
    },
    {
      icon: Gauge,
      title: "Especificações Técnicas",
      description:
        "Controle rigoroso de especificações técnicas, certificações e padrões de qualidade",
    },
    {
      icon: AlertTriangle,
      title: "Controle de Qualidade",
      description:
        "Rastreamento de componentes por especificação técnica e conformidade",
    },
    {
      icon: BarChart3,
      title: "Análise de Performance",
      description:
        "Relatórios detalhados de utilização por equipamento, projeto e período",
    },
  ];
  ...
  const features = [
    {
      ...
      description:
        "Controle de fornecedores, serviços técnicos e qualidade dos componentes",
    },
    {
      icon: FileText,
      title: "Relatórios Técnicos",
      description:
        "Análise de custos por projeto, utilização de equipamentos e performance técnica",
    },
    {
      icon: Smartphone,
      title: "App Mobile",
      description:
        "Controle de estoque em tempo real diretamente no campo e nas instalações",
    },
    {
      icon: Building2,
      title: "Múltiplas Instalações",
      description:
        "Gestão centralizada para empresas com múltiplas instalações ou projetos",
    },
  ];
      ...
      <div className="relative overflow-hidden pt-24 pb-16">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center px-4 py-2 bg-yellow-100 text-yellow-800 rounded-full text-sm font-medium mb-8">
            ...
            {language === "pt"
              ? "Soluções para Setor Elétrico"
              : language === "en"
                ? "Electrical Industry Solutions"
                : "Solutions pour l'Industrie Électrique"}
          </div>

          <h1 className="text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            <span className="bg-gradient-to-r from-gray-900 via-yellow-800 to-gray-900 bg-clip-text text-transparent">
              {language === "pt"
                ? "Gestão de Estoque para Setor Elétrico"
                : language === "en"
                  ? "Inventory Management for Electrical Industry"
                  : "Gestion des Stocks pour l'Industrie Électrique"}
            </span>
          </h1>
      ...
      <div className="py-20 bg-gradient-to-br from-yellow-600 to-orange-600 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
            {language === "pt"
              ? "Pronto para otimizar seu negócio elétrico?"
              : language === "en"
                ? "Ready to optimize your electrical business?"
                : "Prêt à optimiser votre entreprise électrique ?"}
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="https://app.purplestock.com.br/">
              <Button
                size="lg"
                className="bg-white hover:bg-gray-100 text-yellow-700 px-8 py-4 text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 rounded-xl"
              >
            ...
            <Link href="https://app.purplestock.com.br/">
              <Button
                size="lg"
                className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-8 py-4 text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 rounded-xl"
              >
