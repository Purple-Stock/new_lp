...
const industries: Industry[] = [
  ...
  },
  {
    ...
    description:
      "Almoxarifado de obra: materiais, ferramentas e EPI por canteiro, com QR Code.",
    benefits: [
      "Saldo por obra",
      "Ferramentas com responsável",
      "Menos desperdício",
      "Transferência entre canteiros",
    ],
    stats: { value: "Obra", label: "Saldo por canteiro" },
  },
  {
    id: "technology",
...
const industryNames: Record<IndustryId, string> = {
  ...
  construction: "Almoxarifado de Obra e Materiais",
