  ...
  const benefits = [
    {
      ...
      description:
        "Controle preciso de ingredientes por prato com listas detalhadas e custos calculados automaticamente",
    },
    {
      icon: ShoppingCart,
      title: "Controle de Fornecedores",
      description:
        "Gestão eficiente de fornecedores, horários de entrega e qualidade dos ingredientes",
    },
    {
      icon: Calendar,
      title: "Controle de Validade",
      description:
        "Alertas automáticos para produtos próximos ao vencimento e gestão FIFO rigorosa",
    },
    {
      icon: Thermometer,
      title: "Controle de Temperatura",
      description:
        "Monitoramento de condições de armazenamento para ingredientes frescos e congelados",
    },
    {
      icon: AlertTriangle,
      title: "Gestão de Alérgenos",
      description:
        "Controle rigoroso de alérgenos e restrições alimentares para segurança dos clientes",
    },
    {
      icon: BarChart3,
      title: "Análise de Consumo",
      description:
        "Relatórios detalhados de consumo por prato, período e sazonalidade",
    },
  ];
  ...
  const features = [
    {
      ...
      description:
        "Controle de horários de entrega, qualidade dos produtos e gestão de fornecedores",
    },
    {
      icon: FileText,
      title: "Relatórios Detalhados",
      description:
        "Análise de custos por prato, consumo de ingredientes e performance do estoque",
    },
    {
      icon: Smartphone,
      title: "App Mobile",
      description:
        "Controle de estoque em tempo real diretamente na cozinha e no depósito",
    },
    {
      icon: Building2,
      title: "Múltiplas Unidades",
      description:
        "Gestão centralizada para restaurantes com múltiplas filiais ou franquias",
    },
  ];
            ...
            <span className="bg-gradient-to-r from-gray-900 via-emerald-800 to-gray-900 bg-clip-text text-transparent">
              {language === "pt"
                ...
                : language === "en"
                  ...
                  : "Gestion des Stocks pour Restaurants"}
            </span>
          </h1>
      ...
      <div className="py-20 bg-gradient-to-br from-emerald-600 to-green-600 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
            {language === "pt"
              ? "Pronto para otimizar seu restaurante?"
              : language === "en"
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="https://app.purplestock.com.br/">
              <Button
                size="lg"
                className="bg-white hover:bg-gray-100 text-emerald-700 px-8 py-4 text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 rounded-xl"
              >
            ...
            <Link href="https://app.purplestock.com.br/">
              <Button
                size="lg"
                className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-8 py-4 text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 rounded-xl"
              >
