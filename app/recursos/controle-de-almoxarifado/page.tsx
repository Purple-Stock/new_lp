    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-purple-600 to-indigo-600 pt-24 pb-16">
        ...
        <div className="relative mx-auto max-w-6xl px-4 text-center sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-white md:text-6xl">Controle de Almoxarifado para PMEs</h1>
          <p className="mx-auto mt-6 max-w-3xl text-lg text-white/90 md:text-xl">
            Estruture entrada, saída, inventário cíclico e rastreabilidade em uma rotina simples para reduzir erros e ruptura.
          </p>
          ...
          <p className="mt-4 text-sm text-white/80">
            Também pode comparar opções por setor em <Link href="/industrias" className="font-semibold underline">/industrias</Link> e preço em <Link href="/precos" className="font-semibold underline">/precos</Link>.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <article className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
            <h2 className="text-3xl font-bold text-gray-900">Checklist de implantação em 30 dias</h2>
            <p className="mt-4 text-lg text-gray-600">
              Use este roteiro para sair da planilha sem interromper a operação e ganhar previsibilidade no estoque.
            </p>
          ...
          <aside className="rounded-2xl border border-purple-200 bg-purple-50/60 p-8">
            <h2 className="text-2xl font-bold text-gray-900">Ganhos operacionais esperados</h2>
            <div className="mt-6 space-y-4 text-gray-700">
              <p>Menos divergência de inventário e menos compras de urgência.</p>
            ...
            <div className="mt-8 rounded-xl border border-purple-200 bg-white p-5">
              ...
              <ul className="mt-3 space-y-2 text-sm text-gray-700">
                <li>1. Revisar setores e fluxo em <Link href="/industrias" className="font-semibold text-purple-700">/industrias</Link></li>
                <li>2. Validar custo de implantação em <Link href="/precos" className="font-semibold text-purple-700">/precos</Link></li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-gray-900">Perguntas frequentes sobre almoxarifado</h2>
