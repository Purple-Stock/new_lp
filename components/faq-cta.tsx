      ...
      <div className="max-w-4xl mx-auto text-center space-y-16">
        ...
        <div className="space-y-8 h-48">
          ...
          <div className="bg-white rounded-2xl shadow-sm border p-8 relative overflow-hidden h-32">
            ...
            >
              {
                questions[
                  (currentQuestion + questions.length - 1) % questions.length
                ]
              }
            </h4>
          </div>
        ...
        <div className="space-y-6">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Rastreie e gerencie seu inventário em uma única plataforma. Use
            Purple Stock em seu celular, desktop ou tablet para sincronização
            automática e use todos os nossos recursos premium.
          </p>
        </div>
      </div>
    </section>
