        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-tight bg-gradient-to-r from-gray-900 via-purple-800 to-gray-900 bg-clip-text text-transparent">
                {t.title}
              </h1>
              <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 max-w-lg mx-auto lg:mx-0 leading-relaxed">
                {t.description}
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center text-gray-700">
                ...
                <span className="text-base sm:text-lg">{language === "pt" ? "Controle total do inventário" : language === "en" ? "Complete inventory control" : "Contrôle total de l'inventaire"}</span>
              </div>
              <div className="flex items-center text-gray-700">
                <CheckCircle className="w-5 h-5 mr-3 text-green-500 flex-shrink-0" />
                <span className="text-base sm:text-lg">{language === "pt" ? "Relatórios em tempo real" : language === "en" ? "Real-time reporting" : "Rapports en temps réel"}</span>
              </div>
              <div className="flex items-center text-gray-700">
                <CheckCircle className="w-5 h-5 mr-3 text-green-500 flex-shrink-0" />
                <span className="text-base sm:text-lg">{language === "pt" ? "Integração com QR Code" : language === "en" ? "QR Code integration" : "Intégration QR Code"}</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link href="/coming-soon">
                <Button size="lg" className="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <Link href="/coming-soon">
                <Button variant="outline" size="lg" className="border-2 border-purple-200 text-purple-700 hover:bg-purple-50 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold transition-all duration-300">
            ...
            <div className="pt-4">
              ...
              <div className="flex items-center justify-center lg:justify-start space-x-4 sm:space-x-6 text-xs sm:text-sm text-gray-500">
          ...
          <div className="relative">
            ...
            <div className="relative h-[300px] sm:h-[400px] lg:h-[600px] group">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-xl p-3 sm:p-4 border border-gray-100">
                <div className="flex items-center space-x-2 sm:space-x-3">
                  <div className="w-2 h-2 sm:w-3 sm:h-3 bg-green-500 rounded-full animate-pulse"></div>
                  <div>
                    <p className="text-xs sm:text-sm font-semibold text-gray-900">{language === "pt" ? "Estoque Atualizado" : language === "en" ? "Stock Updated" : "Stock Mis à Jour"}</p>
